  ...
  return (
    <Modal open={open} onClose={handleClose} title="שיתוף כל הרשימה">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-zinc-300">שלח הזמנה:</p>
        <div className="flex gap-2">
          <a
            href={buildWhatsAppLink()}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/25 text-emerald-400 font-medium rounded-xl px-4 py-3 transition text-sm"
          >
          ...
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-indigo-500/15 hover:bg-indigo-500/25 border border-indigo-500/25 text-indigo-400 font-medium rounded-xl px-4 py-3 transition text-sm"
          >
            ✉️ מייל
          </a>
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-zinc-500">או — אם הוא כבר רשום</span>
        <div className="flex-1 border-t border-white/8" />
      </div>
